...
def get_datasets(dataset_name, train_transform, test_transform, args):
    ...
    datasets = get_dataset_f(
        train_transform=train_transform, test_transform=test_transform, train_classes=args.train_classes, 
        prop_train_labels=args.prop_train_labels, split_train_val=False
    )
    ...
    return train_dataset, test_dataset, unlabelled_train_examples_test, \
        unlabelled_train_examples_train, datasets, labelled_train_examples, \
            labelled_train_examples_attribute
